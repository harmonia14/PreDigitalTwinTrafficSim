...
ax.set_ylim(0,800)
ax.set_title("Number of running vehicles in the simulation for Scenario 3", fontsize=12)
...
ax.set_title("Number of running vehicles in the simulation for Scenario 3", fontsize=10)
...
ax.set_ylim(0,30)
ax.set_title("Average speed of vehicles in the simulation for Scenario 3", fontsize=12)
