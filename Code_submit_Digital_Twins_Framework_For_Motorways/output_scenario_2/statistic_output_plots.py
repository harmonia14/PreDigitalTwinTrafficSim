...
ax.set_ylim(0,2000)
ax.set_title("Number of running vehicles in the simulation for Scenario 2", fontsize=12)
...
ax.set_title("Number of running vehicles in the simulation for Scenario 2", fontsize=10)
...
ax.set_ylim(0,30)
ax.set_title("Average speed of vehicles in the simulation for Scenario 2", fontsize=12)
